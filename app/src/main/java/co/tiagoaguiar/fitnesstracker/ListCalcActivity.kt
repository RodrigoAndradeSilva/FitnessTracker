...
class ListCalcActivity : AppCompatActivity(), OnListClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // passando o this que é Activity que implementa o OnListClickListener
    ...
    // função de callback que irá disparar o evento de click no item da lista do Adapter
    ...
    // função de callback que irá disparar o evento de long-click no item da lista do Adapter
    ...
    private inner class ListCalcAdapter(
        ...
        private inner class ListCalcViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            fun bind(item: Calc) {
                ...
                // usado para delegar a quem estiver implementando a interface (Activity) o evento para
                //  excluir o item da lista
                tv.setOnLongClickListener {
                    //  precisamos da posição corrente (adapterPosition) para saber qual item da lista
                    //  deve ser removido da recyclerview usando o notify do Adapter
